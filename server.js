...
const options = {
    swaggerDefinition: {
      info: {
        title: 'Assignment 08',
        version: '1.0.0',
        description: 'ITIS-6177 Assignment 08 with autogenerated swagger',
      },
      host:'137.184.102.57:3001',
      basePath: '/',
    },
    apis: ['./server.js'],
  };
 ...
 *       responses:
 *           200:
 *              description: Get all companies from company table
 *           500:
    ...
    .then(conn => {
      ...
      conn.query("SELECT * from company")
        .then((rows) => {
          ...
          res.setHeader('Created-By', 'PranushaApuri');
          res.json(rows);
        })
    });
 ...
 *       responses:
 *           200:
 *              description: get all food details from the foods table
 *           500:
 *              description: Internal server error
 *
 */
 ...
 *       responses:
 *           200:
 *              description: get all students from the student table
 *           500:
 *              description: Internal server error
 *
 */
